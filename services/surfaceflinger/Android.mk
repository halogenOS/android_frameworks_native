...
LOCAL_CFLAGS += -DDEBUG_CONT_DUMPSYS -DSUPERVERBOSE
else
LOCAL_CFLAGS += -O3
LOCAL_CPPFLAGS += -O3
endif
...
ifeq ($(LEGACY_NEEDS_PUBLIC_LAYERVECTOR),true)
	LOCAL_CFLAGS += -DLEGACY_NEEDS_PUBLIC_LAYERVECTOR
	LOCAL_CPPFLAGS += -DLEGACY_NEEDS_PUBLIC_LAYERVECTOR
endif
